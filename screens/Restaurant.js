...
const Restaurant = ({ route, navigation }) => {
    ...
    function renderHeader() {
        return (
            <View style={{ flexDirection: 'row',backgroundColor: COLORS.primary, borderBottomRightRadius:30, borderBottomLeftRadius:30, marginBottom:5 }}>
                <TouchableOpacity
                    style={{
                        width: 50,
            ...
            <View>
                ...
                >
                    ...
                    >
                        ...
                        <Text style={{ ...FONTS.h3 }}>LKR {sumOrder()}</Text>
                    </View>
